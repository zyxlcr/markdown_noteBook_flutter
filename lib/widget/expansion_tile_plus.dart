...
////? Misc
      ...
      hiddenHead: hiddenHead ?? this.hiddenHead,
...
class _ExpandedTileState extends State<ExpandedTile>
  ...
  late bool _hiddenHead;
  @override
  void initState() {
    tileController = widget.controller;
    _isExpanded = widget.isExpanded;
    _hiddenHead = widget.hiddenHead;
    tileController.addListener(modChange);
  ...
  void dispose() {
    ...
    print("dispose");
    tileController.removeListener(modChange);
    super.dispose();
  }
